...
async def xma(message: types.Message):
    ...
    await message.answer(f"<ins>Адресс:</ins> г. Ханты-Мансийск, {count_table_2}\n"
                         ...
                         f"<b>ПЭТ-бутылка прозрачная, цветная\nПЭТ-бутылка белая (матовая)\nПНД-упаковка от бытовой"
                         f" химии\nПНД-канистраПНД-ящик\nСтретч-пленка ПВД\nПленка ПВД «пузырчатая»\nПакеты фасовочные"
                         f" (ПНД/ПВД)\nМакулатура (картон, бумага, книги, тетради)\nСтекло (прозрачное, коричневое и "
                         f"зеленое - бутылки и банки)\nАлюминиевые банки\nОтработанные батарейки\nПластиковые крышечки\n"
                         f" Жестяная банка, жестяная крышка\nБытовая и офисная техника,"
                         f" утратившая потребительские свойства</b>",
