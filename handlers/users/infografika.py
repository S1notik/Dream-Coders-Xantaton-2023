...
from keyboards.inline.inline_buttons import keyboard
...
async def infografika(message: types.Message):
    await message.answer("Здесь вы можете узнать о переработке разных материалов", reply_markup=keyboard)


@my_router.message(F.text == "Батарейки")
